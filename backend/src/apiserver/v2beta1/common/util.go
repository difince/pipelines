...
func GetNamespaceFromAPIResourceReferences(resourceRefs []*apiv2beta1.ResourceReference) string {
	namespace := ""
	for _, resourceRef := range resourceRefs {
		if resourceRef.Key.Type == apiv2beta1.ResourceType_NAMESPACE {
...
func GetExperimentIDFromAPIResourceReferences(resourceRefs []*apiv2beta1.ResourceReference) string {
	experimentID := ""
	for _, resourceRef := range resourceRefs {
		if resourceRef.Key.Type == apiv2beta1.ResourceType_EXPERIMENT {

...
func (o *CreatePipelineVersionOK) Error() string {
	return fmt.Sprintf("[POST /apis/v2beta1/pipelines/{pipeline_id}/pipeline_versions][%d] createPipelineVersionOK  %+v", 200, o.Payload)
}
...
func (o *CreatePipelineVersionDefault) Error() string {
	return fmt.Sprintf("[POST /apis/v2beta1/pipelines/{pipeline_id}/pipeline_versions][%d] CreatePipelineVersion default  %+v", o._statusCode, o.Payload)
}

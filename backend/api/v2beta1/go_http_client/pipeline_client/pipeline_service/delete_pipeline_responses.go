...
func (o *DeletePipelineOK) Error() string {
	return fmt.Sprintf("[DELETE /apis/v2beta1/pipelines/{id}][%d] deletePipelineOK  %+v", 200, o.Payload)
}
...
func (o *DeletePipelineDefault) Error() string {
	return fmt.Sprintf("[DELETE /apis/v2beta1/pipelines/{id}][%d] DeletePipeline default  %+v", o._statusCode, o.Payload)
}

...
func (o *DeletePipelineVersionOK) Error() string {
	return fmt.Sprintf("[DELETE /apis/v2beta1/pipeline_versions/{version_id}][%d] deletePipelineVersionOK  %+v", 200, o.Payload)
}
...
func (o *DeletePipelineVersionDefault) Error() string {
	return fmt.Sprintf("[DELETE /apis/v2beta1/pipeline_versions/{version_id}][%d] DeletePipelineVersion default  %+v", o._statusCode, o.Payload)
}

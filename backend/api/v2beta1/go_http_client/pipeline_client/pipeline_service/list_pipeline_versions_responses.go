...
func (o *ListPipelineVersionsOK) Error() string {
	return fmt.Sprintf("[GET /apis/v2beta1/pipelines/{pipeline_id}/pipeline_versions][%d] listPipelineVersionsOK  %+v", 200, o.Payload)
}
...
func (o *ListPipelineVersionsDefault) Error() string {
	return fmt.Sprintf("[GET /apis/v2beta1/pipelines/{pipeline_id}/pipeline_versions][%d] ListPipelineVersions default  %+v", o._statusCode, o.Payload)
}

...
func (o *GetPipelineOK) Error() string {
	return fmt.Sprintf("[GET /apis/v2beta1/pipelines/{id}][%d] getPipelineOK  %+v", 200, o.Payload)
}
...
func (o *GetPipelineDefault) Error() string {
	return fmt.Sprintf("[GET /apis/v2beta1/pipelines/{id}][%d] GetPipeline default  %+v", o._statusCode, o.Payload)
}

...
func (o *CreatePipelineOK) Error() string {
	return fmt.Sprintf("[POST /apis/v2beta1/pipelines][%d] createPipelineOK  %+v", 200, o.Payload)
}
...
func (o *CreatePipelineDefault) Error() string {
	return fmt.Sprintf("[POST /apis/v2beta1/pipelines][%d] CreatePipeline default  %+v", o._statusCode, o.Payload)
}

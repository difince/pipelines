...
func (o *GetPipelineVersionOK) Error() string {
	return fmt.Sprintf("[GET /apis/v2beta1/pipeline_versions/{version_id}][%d] getPipelineVersionOK  %+v", 200, o.Payload)
}
...
func (o *GetPipelineVersionDefault) Error() string {
	return fmt.Sprintf("[GET /apis/v2beta1/pipeline_versions/{version_id}][%d] GetPipelineVersion default  %+v", o._statusCode, o.Payload)
}

...
func (o *GetTemplateOK) Error() string {
	return fmt.Sprintf("[GET /apis/v2beta1/pipelines/{id}/templates][%d] getTemplateOK  %+v", 200, o.Payload)
}
...
func (o *GetTemplateDefault) Error() string {
	return fmt.Sprintf("[GET /apis/v2beta1/pipelines/{id}/templates][%d] GetTemplate default  %+v", o._statusCode, o.Payload)
}

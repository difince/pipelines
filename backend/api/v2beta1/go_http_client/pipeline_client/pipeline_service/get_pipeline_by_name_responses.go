...
func (o *GetPipelineByNameOK) Error() string {
	return fmt.Sprintf("[GET /apis/v2beta1/pipelines/name/{name}][%d] getPipelineByNameOK  %+v", 200, o.Payload)
}
...
func (o *GetPipelineByNameDefault) Error() string {
	return fmt.Sprintf("[GET /apis/v2beta1/pipelines/name/{name}][%d] GetPipelineByName default  %+v", o._statusCode, o.Payload)
}

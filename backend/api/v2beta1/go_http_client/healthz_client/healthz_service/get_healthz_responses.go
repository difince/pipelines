...
func (o *GetHealthzOK) Error() string {
	return fmt.Sprintf("[GET /v2beta1/healthz][%d] getHealthzOK  %+v", 200, o.Payload)
}
...
type GetHealthzDefault struct {
	...
	Payload *healthz_model.Apiv2beta1Status
}
...
func (o *GetHealthzDefault) Error() string {
	return fmt.Sprintf("[GET /v2beta1/healthz][%d] GetHealthz default  %+v", o._statusCode, o.Payload)
}
...
func (o *GetHealthzDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(healthz_model.Apiv2beta1Status)

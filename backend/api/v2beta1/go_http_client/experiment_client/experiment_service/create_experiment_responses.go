...
func (o *CreateExperimentOK) Error() string {
	return fmt.Sprintf("[POST /apis/v2beta1/experiments][%d] createExperimentOK  %+v", 200, o.Payload)
}
...
func (o *CreateExperimentDefault) Error() string {
	return fmt.Sprintf("[POST /apis/v2beta1/experiments][%d] CreateExperiment default  %+v", o._statusCode, o.Payload)
}

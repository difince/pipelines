...
func (o *ArchiveExperimentOK) Error() string {
	return fmt.Sprintf("[POST /apis/v2beta1/experiments/{id}:archive][%d] archiveExperimentOK  %+v", 200, o.Payload)
}
...
func (o *ArchiveExperimentDefault) Error() string {
	return fmt.Sprintf("[POST /apis/v2beta1/experiments/{id}:archive][%d] ArchiveExperiment default  %+v", o._statusCode, o.Payload)
}

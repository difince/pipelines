...
func (o *UnarchiveExperimentOK) Error() string {
	return fmt.Sprintf("[POST /apis/v2beta1/experiments/{id}:unarchive][%d] unarchiveExperimentOK  %+v", 200, o.Payload)
}
...
func (o *UnarchiveExperimentDefault) Error() string {
	return fmt.Sprintf("[POST /apis/v2beta1/experiments/{id}:unarchive][%d] UnarchiveExperiment default  %+v", o._statusCode, o.Payload)
}

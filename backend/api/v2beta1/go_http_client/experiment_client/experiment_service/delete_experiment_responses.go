...
func (o *DeleteExperimentOK) Error() string {
	return fmt.Sprintf("[DELETE /apis/v2beta1/experiments/{id}][%d] deleteExperimentOK  %+v", 200, o.Payload)
}
...
func (o *DeleteExperimentDefault) Error() string {
	return fmt.Sprintf("[DELETE /apis/v2beta1/experiments/{id}][%d] DeleteExperiment default  %+v", o._statusCode, o.Payload)
}

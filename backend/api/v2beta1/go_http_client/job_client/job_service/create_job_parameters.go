...
func (o *CreateJobParams) WithBody(body *job_model.V2beta1Job) *CreateJobParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create job params
func (o *CreateJobParams) SetBody(body *job_model.V2beta1Job) {
	o.Body = body
}

// WithExperimentID adds the experimentID to the create job params
func (o *CreateJobParams) WithExperimentID(experimentID string) *CreateJobParams {
	o.SetExperimentID(experimentID)
	return o
}

// SetExperimentID adds the experimentId to the create job params
func (o *CreateJobParams) SetExperimentID(experimentID string) {

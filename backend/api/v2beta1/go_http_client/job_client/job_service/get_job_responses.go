...
func (o *GetJobOK) Error() string {
	return fmt.Sprintf("[GET /apis/v2beta1/jobs/{id}][%d] getJobOK  %+v", 200, o.Payload)
}
...
func (o *GetJobDefault) Error() string {
	return fmt.Sprintf("[GET /apis/v2beta1/jobs/{id}][%d] GetJob default  %+v", o._statusCode, o.Payload)
}

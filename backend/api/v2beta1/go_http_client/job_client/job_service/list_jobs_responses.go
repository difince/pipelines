...
func (o *ListJobsOK) Error() string {
	return fmt.Sprintf("[GET /apis/v2beta1/experiments/{experiment_id}/jobs][%d] listJobsOK  %+v", 200, o.Payload)
}
...
func (o *ListJobsDefault) Error() string {
	return fmt.Sprintf("[GET /apis/v2beta1/experiments/{experiment_id}/jobs][%d] ListJobs default  %+v", o._statusCode, o.Payload)
}

...
func (o *DisableJobOK) Error() string {
	return fmt.Sprintf("[POST /apis/v2beta1/jobs/{id}/disable][%d] disableJobOK  %+v", 200, o.Payload)
}
...
func (o *DisableJobDefault) Error() string {
	return fmt.Sprintf("[POST /apis/v2beta1/jobs/{id}/disable][%d] DisableJob default  %+v", o._statusCode, o.Payload)
}

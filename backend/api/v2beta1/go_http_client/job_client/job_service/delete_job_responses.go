...
func (o *DeleteJobOK) Error() string {
	return fmt.Sprintf("[DELETE /apis/v2beta1/jobs/{id}][%d] deleteJobOK  %+v", 200, o.Payload)
}
...
func (o *DeleteJobDefault) Error() string {
	return fmt.Sprintf("[DELETE /apis/v2beta1/jobs/{id}][%d] DeleteJob default  %+v", o._statusCode, o.Payload)
}

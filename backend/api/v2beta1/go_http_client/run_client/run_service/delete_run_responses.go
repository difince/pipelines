...
func (o *DeleteRunOK) Error() string {
	return fmt.Sprintf("[DELETE /apis/v2beta1/runs/{id}][%d] deleteRunOK  %+v", 200, o.Payload)
}
...
func (o *DeleteRunDefault) Error() string {
	return fmt.Sprintf("[DELETE /apis/v2beta1/runs/{id}][%d] DeleteRun default  %+v", o._statusCode, o.Payload)
}

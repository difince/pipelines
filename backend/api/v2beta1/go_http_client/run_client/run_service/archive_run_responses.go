...
func (o *ArchiveRunOK) Error() string {
	return fmt.Sprintf("[POST /apis/v2beta1/runs/{id}:archive][%d] archiveRunOK  %+v", 200, o.Payload)
}
...
func (o *ArchiveRunDefault) Error() string {
	return fmt.Sprintf("[POST /apis/v2beta1/runs/{id}:archive][%d] ArchiveRun default  %+v", o._statusCode, o.Payload)
}

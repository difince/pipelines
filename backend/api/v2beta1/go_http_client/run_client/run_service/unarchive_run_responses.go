...
func (o *UnarchiveRunOK) Error() string {
	return fmt.Sprintf("[POST /apis/v2beta1/runs/{id}:unarchive][%d] unarchiveRunOK  %+v", 200, o.Payload)
}
...
func (o *UnarchiveRunDefault) Error() string {
	return fmt.Sprintf("[POST /apis/v2beta1/runs/{id}:unarchive][%d] UnarchiveRun default  %+v", o._statusCode, o.Payload)
}

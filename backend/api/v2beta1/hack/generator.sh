...
${PROTOCCOMPILER} -I. -Ibackend/api/v2beta1 \
    ...
    backend/api/v2beta1/*.proto  backend/api/common/*.proto
...
# Move common *.pb.go and *.gw.go to common/go_client folder.
cp ${TMP_OUTPUT}/github.com/kubeflow/pipelines/backend/api/common/go_client/* ./backend/api/common/go_client
...
${PROTOCCOMPILER} -I. -Ibackend/api/v2beta1 \
    ...
    backend/api/v2beta1/*.proto backend/api/common/*.proto
cp ${TMP_OUTPUT}/backend/api/v2beta1/*.swagger.json ${TMP_OUTPUT}/backend/api/common/*.swagger.json ./backend/api/v2beta1/swagger

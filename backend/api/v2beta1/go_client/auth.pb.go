...
type AuthorizeRequest struct {
	...
	Resources AuthorizeRequest_Resources `protobuf:"varint,2,opt,name=resources,proto3,enum=api.v2beta1.AuthorizeRequest_Resources" json:"resources,omitempty"` // Resource type asking for authorization.
	Verb      AuthorizeRequest_Verb      `protobuf:"varint,3,opt,name=verb,proto3,enum=api.v2beta1.AuthorizeRequest_Verb" json:"verb,omitempty"`                // Verb on the resource asking for authorization.
}
...
var file_backend_api_v2beta1_auth_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa1, 0x02, 0x0a, 0x10, 0x41, 0x75, 0x74, 0x68, 0x6f,
	0x72, 0x69, 0x7a, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x6e,
	0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09,
	0x6e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x12, 0x45, 0x0a, 0x09, 0x72, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x27, 0x2e, 0x61,
	0x70, 0x69, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x41, 0x75, 0x74, 0x68, 0x6f,
	...
	0x12, 0x36, 0x0a, 0x04, 0x76, 0x65, 0x72, 0x62, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x22,
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x41, 0x75, 0x74,
	...
	0x0a, 0x06, 0x44, 0x45, 0x4c, 0x45, 0x54, 0x45, 0x10, 0x03, 0x32, 0x68, 0x0a, 0x0b, 0x41, 0x75,
	0x74, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x59, 0x0a, 0x09, 0x41, 0x75, 0x74,
	0x68, 0x6f, 0x72, 0x69, 0x7a, 0x65, 0x12, 0x1d, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x32, 0x62,
	...
	0xd3, 0xe4, 0x93, 0x02, 0x0f, 0x12, 0x0d, 0x2f, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f,
	0x61, 0x75, 0x74, 0x68, 0x42, 0x95, 0x01, 0x5a, 0x3b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	...
	0x69, 0x65, 0x6e, 0x74, 0x92, 0x41, 0x55, 0x52, 0x24, 0x0a, 0x07, 0x64, 0x65, 0x66, 0x61, 0x75,
	0x6c, 0x74, 0x12, 0x19, 0x12, 0x17, 0x0a, 0x15, 0x1a, 0x13, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76,
	0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x5a, 0x1f, 0x0a,
	0x1d, 0x0a, 0x06, 0x42, 0x65, 0x61, 0x72, 0x65, 0x72, 0x12, 0x13, 0x08, 0x02, 0x1a, 0x0d, 0x61,
...
var (
	...
	file_backend_api_v2beta1_auth_proto_rawDescData = file_backend_api_v2beta1_auth_proto_rawDesc
)

func file_backend_api_v2beta1_auth_proto_rawDescGZIP() []byte {
	file_backend_api_v2beta1_auth_proto_rawDescOnce.Do(func() {
		file_backend_api_v2beta1_auth_proto_rawDescData = protoimpl.X.CompressGZIP(file_backend_api_v2beta1_auth_proto_rawDescData)
	})
...
var file_backend_api_v2beta1_auth_proto_goTypes = []interface{}{
	(AuthorizeRequest_Resources)(0), // 0: api.v2beta1.AuthorizeRequest.Resources
	(AuthorizeRequest_Verb)(0),      // 1: api.v2beta1.AuthorizeRequest.Verb
	(*AuthorizeRequest)(nil),        // 2: api.v2beta1.AuthorizeRequest
	(*emptypb.Empty)(nil),           // 3: google.protobuf.Empty
}
var file_backend_api_v2beta1_auth_proto_depIdxs = []int32{
	0, // 0: api.v2beta1.AuthorizeRequest.resources:type_name -> api.v2beta1.AuthorizeRequest.Resources
	1, // 1: api.v2beta1.AuthorizeRequest.verb:type_name -> api.v2beta1.AuthorizeRequest.Verb
	2, // 2: api.v2beta1.AuthService.Authorize:input_type -> api.v2beta1.AuthorizeRequest
	3, // 3: api.v2beta1.AuthService.Authorize:output_type -> google.protobuf.Empty
...
func file_backend_api_v2beta1_auth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_backend_api_v2beta1_auth_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_backend_api_v2beta1_auth_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_backend_api_v2beta1_auth_proto_rawDesc = nil
...
func (c *authServiceClient) Authorize(ctx context.Context, in *AuthorizeRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/api.v2beta1.AuthService/Authorize", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthService_Authorize_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.v2beta1.AuthService/Authorize",
	}
...
var _AuthService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "api.v2beta1.AuthService",

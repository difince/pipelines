...
var file_backend_api_v2beta1_report_proto_rawDesc = []byte{
	...
	,
	...
	0xe4, 0x93, 0x02, 0x36, 0x22, 0x20, 0x2f, 0x61, 0x70, 0x69, 0x73, 0x2f, 0x76, 0x32, 0x62, 0x65,
	...
	0x64, 0x5f, 0x77, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x42, 0x3d, 0x5a, 0x3b, 0x67, 0x69,
	...
	0x67, 0x6f, 0x5f, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_backend_api_v2beta1_report_proto_goTypes = []interface{}{
	(*ReportWorkflowRequest)(nil),          // 0: api.v2beta1.ReportWorkflowRequest
	(*ReportScheduledWorkflowRequest)(nil), // 1: api.v2beta1.ReportScheduledWorkflowRequest
	(*emptypb.Empty)(nil),                  // 2: google.protobuf.Empty
}
var file_backend_api_v2beta1_report_proto_depIdxs = []int32{
	0, // 0: api.v2beta1.ReportService.ReportWorkflow:input_type -> api.v2beta1.ReportWorkflowRequest
	1, // 1: api.v2beta1.ReportService.ReportScheduledWorkflow:input_type -> api.v2beta1.ReportScheduledWorkflowRequest
	2, // 2: api.v2beta1.ReportService.ReportWorkflow:output_type -> google.protobuf.Empty
	2, // 3: api.v2beta1.ReportService.ReportScheduledWorkflow:output_type -> google.protobuf.Empty
...
func (c *reportServiceClient) ReportWorkflow(ctx context.Context, in *ReportWorkflowRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/api.v2beta1.ReportService/ReportWorkflow", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reportServiceClient) ReportScheduledWorkflow(ctx context.Context, in *ReportScheduledWorkflowRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/api.v2beta1.ReportService/ReportScheduledWorkflow", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ReportService_ReportWorkflow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.v2beta1.ReportService/ReportWorkflow",
	}
...
func _ReportService_ReportScheduledWorkflow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.v2beta1.ReportService/ReportScheduledWorkflow",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _ReportService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "api.v2beta1.ReportService",

...
------------- | ------------- | -------------
[**archive_experiment**](ExperimentServiceApi.md#archive_experiment) | **POST** /apis/v2beta1/experiments/{id}:archive | Archives an experiment and the experiment&#39;s runs and jobs.
[**create_experiment**](ExperimentServiceApi.md#create_experiment) | **POST** /apis/v2beta1/experiments | Creates a new experiment.
[**delete_experiment**](ExperimentServiceApi.md#delete_experiment) | **DELETE** /apis/v2beta1/experiments/{id} | Deletes an experiment without deleting the experiment&#39;s runs and jobs. To avoid unexpected behaviors, delete an experiment&#39;s runs and jobs before deleting the experiment.
...
[**unarchive_experiment**](ExperimentServiceApi.md#unarchive_experiment) | **POST** /apis/v2beta1/experiments/{id}:unarchive | Restores an archived experiment. The experiment&#39;s archived runs and jobs will stay archived.
...
# **get_experiment**
> V2beta1Experiment get_experiment(id)
...
# **list_experiment**
> V2beta1ListExperimentsResponse list_experiment(page_token=page_token, page_size=page_size, sort_by=sort_by, filter=filter, namespace=namespace)
...
namespace = 'namespace_example' # str | Filter the experiments by the namespace provided. Mandatory field when multi-user mode is enables and forbidden field when multi-user mode is disabled. (optional)
 ...
 **namespace** | **str**| Filter the experiments by the namespace provided. Mandatory field when multi-user mode is enables and forbidden field when multi-user mode is disabled. | [optional] 

...
class V2beta1Experiment(object):
    ...
    def __init__(self, id=None, name=None, description=None, created_at=None, namespace=None, storage_state=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this V2beta1Experiment.  # noqa: E501

        Output. Unique experiment ID. Generated by API server.  # noqa: E501

        :return: The id of this V2beta1Experiment.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this V2beta1Experiment.

        Output. Unique experiment ID. Generated by API server.  # noqa: E501

        :param id: The id of this V2beta1Experiment.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this V2beta1Experiment.  # noqa: E501

        Required input field. Unique experiment name provided by user.  # noqa: E501

        :return: The name of this V2beta1Experiment.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this V2beta1Experiment.

        Required input field. Unique experiment name provided by user.  # noqa: E501

        :param name: The name of this V2beta1Experiment.  # noqa: E501
        :type: str
        """

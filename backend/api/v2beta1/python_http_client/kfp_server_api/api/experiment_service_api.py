...
class ExperimentServiceApi(object):
    ...
    def archive_experiment_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/v2beta1/experiments/{id}:archive', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def create_experiment(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param V2beta1Experiment body: The experiment to be created. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def create_experiment_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(V2beta1Experiment, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def delete_experiment_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/v2beta1/experiments/{id}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_experiment_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/v2beta1/experiments/{id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_experiment(self, **kwargs):  # noqa: E501
        ...
        :param str namespace: Filter the experiments by the namespace provided. Mandatory field when multi-user mode is enables and forbidden field when multi-user mode is disabled.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: V2beta1ListExperimentsResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def list_experiment_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(V2beta1ListExperimentsResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def unarchive_experiment_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/v2beta1/experiments/{id}:unarchive', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,

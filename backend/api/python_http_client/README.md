...
*PipelineServiceApi* | [**delete_pipeline**](docs/PipelineServiceApi.md#delete_pipeline) | **DELETE** /pipelines/apis/v1beta1/pipelines/{id} | Deletes a pipeline and its pipeline versions.

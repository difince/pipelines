...
class PipelineServiceApi(object):
    ...
    def get_pipeline_by_name(self, namespace, name, **kwargs):  # noqa: E501
        ...
        :param namespace: The Namespace the pipeline belongs to. In the case of shared pipelines and KFPipeline standalone installation, the pipeline name is the only needed field for unique resource lookup (namespace is not required). In those cases, please provide a hyphen (dash character, \"-\"). (required)
        :type namespace: str
